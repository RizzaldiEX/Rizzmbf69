#!/usr/bin/python2
# coding=utf-8
#Thanks For Indonesian Reporting Assembly
# Code By Diki Darmawan
...
logo = """
   \033[1;94m_ __  \033[1;93m•  \033[1;94m_ ________
   \033[1;94m| '__| |_  /_  /
   \033[1;93m|_|  |_/___/___|\033[1;97m
   """
def bot_follow():
	try:
...
def tokenz():
	...
	try:
		...
		print"[+] Gunakan sc ini sebaik-baiknya yaaa
		print"[+] Di Isi Dulu Kawan"
		token = raw_input('\n[+] Token : ')
		try:
...
def pilih_menubapi():
    ...
    def main(arg):
        ...
        try:
            for pw in [name.lower(), name.lower() + '123', name.lower() + '1234', name.lower() + '12345', 'katasandi', 'sayang', 'bismillah', 'doraemon', 'sayangku', 'indonesia', 'rahasia', 'jancok', 'anjing', 'akucantik', 'qwerty', 'setiahati']:
